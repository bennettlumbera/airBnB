...
class UserManager(models.Manager):
    def valid_registration(self, user_info):
        ...
        if valid == True:
            ...
            user = User.objects.create(first_name=user_info['first_name'], last_name=user_info['last_name'], birthday=user_info['birthday'], email=user_info['email'], password=hashed,
                                       phone_number=user_info['phone_number'], city=user_info['city'], state=user_info['state'], country=user_info['country'], zip_code=user_info['zip_code'])
            user.save()
